...
Quiz.L = {
    ...
    W_WIDGET_SETTINGS_HELP = "Changes apply immediately. SharedMedia fonts come from your installed addons. Volume adjusts streak sounds relative to your game sound-effects level; 0% mutes them.",
