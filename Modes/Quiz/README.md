...
- Quiz pack IDs, question IDs, canonical rules keys and scoring versions are persistent identities; preserve them across application updates.
...
- Archived league and 100-point standings are preservation-only historical data; do not restore them to commands, chat output or the Scores dropdown.
